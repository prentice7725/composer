...
- C5-A through C5-I = optional PySide6 authoring client with core-rendered
  Canvas, Tree, Inspector, workbenches, diagnostics, persistence, and
  ephemeral UI state
  (ui/)
...
from .derived import DerivedCandidate, DerivedCandidateError, adopt_derived_split, revert_derived_split
...
__all__ = [
    "AssemblyDocument",
    "DerivedCandidate",
    "DerivedCandidateError",
    "adopt_derived_split",
    "revert_derived_split",
